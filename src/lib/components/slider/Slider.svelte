...
<div class="relative bg-embla-carousel p-4 overflow-hidden rounded-[.25rem]">
  <div
    ...
    use:embla={{ store: carousel }}
    on:e-select={onSelect}
  >
    <div
      class="grid grid-flow-col auto-cols-[100%] grid-rows-[320px] gap-x-[10px]"
    >
    ...
    {#each images as _, index}
      ...
      >
        <div
          ...
          class:[background:linear-gradient(45deg,#ff9500,#ffcc00)]={selected ===
            index}
        />
      </button>
    {/each}
